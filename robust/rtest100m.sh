...
echo rtest -x -f $1 -e $2 -p 500 -q 500 -n 10000  -t 3 -d 48 -r 1 >> $1.test100m
time rtest -x -f $1 -e $2 -p 500 -q 500 -n 10000  -t 3 -d 48 -r 1 >> $1.test100m
...
echo rtest -x -f $1 -e $2 -p 500 -q 500 -n 5000 -t 9 -d 4 -r 1  >> $1.test100m
time rtest -x -f $1 -e $2 -p 500 -q 500 -n 5000 -t 9 -d 4 -r 1 >> $1.test100m

# 18s 15s
echo >> $1.test100m
echo fftest: >> $1.test100m
echo rtest -x -f $1 -e $2 -p 500 -q 500 -n 8192 -t 10 -d 1 -r 1  >> $1.test100m
time rtest -x -f $1 -e $2 -p 200 -q 200 -n 8192 -t 10 -d 1 -r 1 >> $1.test100m
...
echo rtest -x -f $1 -e $2 -p 100 -q 100 -n 2097171 -t 13 -d 1 -r 1 >> $1.test100m
time rtest -x -f $1 -e $2 -p 100 -q 100 -n 2097171 -t 13 -d 1 -r 1 >> $1.test100m

# 4s 6s
echo >> $1.test100m
echo bitstream_n: >> $1.test100m
echo rtest -x -f $1 -e $2 -p 10 -q 10 -n 41943040 -t 14 -d 1 -r 1 >> $1.test100m
time rtest -x -f $1 -e $2 -p 10 -q 10 -n 41943040 -t 14 -d 1 -r 1 >> $1.test100m
